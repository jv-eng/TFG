...
<head>
	<title>Profesor_Publicar_Franja</title>
...
<div align="right"><a href="https://www.fi.upm.es/" target="_blank"><img src="imagenes/logo_etsiinf_transparente.png"></a></div>
	...
	if (isset($_COOKIE["mail"]) && isset($_COOKIE["id_sesion"])) {
		if ($_COOKIE["mail"] != "" && $_COOKIE["id_sesion"] != "") {
			...
			if ($result) {
				...
				$recibir_publicacion_franja = "recibir_publicacion_franja.php";
	...
	?>
		...
		<?php
				...
				// $recibir_publicacion_franja = "Login.php";
	...
	<div class="main-container">
		...
		<form action=<?php echo $recibir_publicacion_franja ?> method="POST">
			<p class="generalseparator">
				<b>Asignatura:</b> <input type="text" name="asignatura" required></br>
				<b>Tipo:</b> <select name="tipo" required>
					<option selected value="0"> Elige una opción </option>
					<option value="1">Tutoría</option>
					<option value="2">Corrección de exámen</option>
					<option value="3">Corrección de prácticas</option>
				</select> </br>
