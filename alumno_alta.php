...
<body onload="todayDate()">
	...
	<div class="main-container">
		...
		<form action="recibir_alumno_alta.php" method="POST" class="generalseparator">
			<p>
				<b>Nombre:</b> <input type="text" name="nombre"></br>
				<b>Apellidos:</b> <input type="text" name="apellido"></br>
				<b>Correo:</b> <input type="text" name="mail">
				<select name="tipo_mail" required>
					<option selected value=""> Elige un dominio </option>
					<option value="@upm.es">@upm.es</option>
					<option value="@alumnos.upm.es">@alumnos.upm.es</option>
