...
<head>
	<title>Profesor_Publicar_Semestral</title>
...
<div align="right"><a href="https://www.fi.upm.es/" target="_blank"><img src="imagenes/logo_etsiinf_transparente.png"></a></div>
	...
	<div class="main-container">
		...
		<h3 class="generalseparator marineblue">Introduzca los datos de la franja a publicar a continuación:</h3>

		<form action=<?php echo "recibir_publicacion_franja_semestral.php" ?> method="POST">
			<p class="generalseparator">
				<b>Asignatura:</b> <input type="text" name="asignatura" required></br>
				<b>Tipo:</b> <input type="text" name="tipo" placeholder="Tutoria" readonly="readonly"> </br>
				<b>Semestre:</b> <select name="semestre" required>
					<option selected value="0"> Elige una opción </option>
					<option value="semestre_impar">Semestre impar (septiembre-diciembre)</option>
					<option value="semestre_par">Semestre par (enero-junio)</option>
					<option value="ambos">Ambos semestres</option>
				</select> </br>
				<b>Día:</b> <input type="date" name="dia" required></br>
				...
				<select name="minutos" required>
					<option selected value="0">Mins</option>
					<option value="00">00</option>
					<option value="05">05</option>
					<option value="10">10</option>
					<option value="15">15</option>
				...
				<b>Número de citas:</b> <input type="number" name="numero_slots" min="0" max="10" required></br>
				<b>Duración de las citas:</b> <select name="duracion_slots" required>
					<option selected value="0">Tiempo citas</option>
					<option value="00">00</option>
					<option value="05">05</option>
					<option value="10">10</option>
					<option value="15">15</option>
				...
				<b>Ubicación:</b> <input type="text" name="ubicacion" required></br>
			</p>
			<input type="hidden" name="mail" value=<?php echo $_POST["mail"] ?>>
			<input type="hidden" name="id" value=<?php echo $_POST["id"] ?>>
	...
	<div class="backandforthbuttons">
		...
		<form action=<?php echo "Profesor_franjas.php" ?> method="POST" class="backbutton">
			<input type="hidden" name="mail" value=<?php echo $_POST["mail"] ?>>
			<input type="hidden" name="id" value=<?php echo $_POST["id"] ?>>
